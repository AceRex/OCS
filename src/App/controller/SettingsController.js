function formatPlanDetails(
  ...
  if (!isAuthenticated) {
    ...
    return {
      ...
      daysColor:
        guestRemainingMinutes <= 10 ? "text-rose-400" : "text-amber-400",
      days: 0,
      isGuest: true,
      guestExpired: false,
    };
...
export default function SettingsController() {
  ...
  const [liveTranscriptCorrection, setLiveTranscriptCorrection] =
    useState(false);
  const [sessionTranscriptCleanup, setSessionTranscriptCleanup] =
    useState(false);
  ...
  useEffect(() => {
    ...
    const unsubStyle = window.electron?.Presentation?.onSetStyle?.(
      (newStyle) => {
    ...
    const unsubBumpers = window.electron?.Bumper?.onBumpersUpdated?.(
      async () => {
        if (window.electron?.Bumper?.get) {
          try {
            const b = await window.electron.Bumper.get();
  ...
  return (
    <div
      className="flex flex-col gap-0 text-white h-full overflow-hidden font-outfit bg-[#0B0814]"
      ...
      <div className="px-8 pt-6 pb-5 border-b border-[#2E2542] bg-[#0E0A1A]/80 backdrop-blur-md">
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-black uppercase tracking-widest text-[#F5F2FA]">
      ...
      <div className="flex-1 overflow-y-auto p-8 space-y-6 no-scrollbar">
          ...
          <div className="space-y-6 max-w-4xl">
            ...
            <div className="bg-[#1A1428] border border-[#2E2542] p-6 rounded-3xl space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[11px] text-[#8882A4]">
                    Real-time visual reflection on Speaker & General screens
                  </p>
                </div>
              ...
              >
                ...
                <div className="relative z-10 text-center space-y-2 max-w-xl">
                  ...
                  <p
                    ...
                    style={{ color: styles.accentColor || "#A788FA" }}
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <button
                      ...
                      className={`w-6 h-6 rounded-lg border transition-transform ${
                        styles.backgroundColor === color
                          ? "border-[#A788FA] scale-110 shadow-md"
              ...
              <div className="bg-[#1A1428] border border-[#2E2542] p-5 rounded-3xl space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <span className="text-[10px] text-[#8882A4] font-bold block mb-1">
                      Text Color
                    </span>
            ...
            <div className="bg-[#1A1428] border border-[#2E2542] p-5 rounded-3xl space-y-4">
                ...
                {FONT_OPTIONS.map((f) => (
                  ...
                  >
                    <span
                      ...
                      className="block text-sm font-black mb-0.5"
                    >
                      Aa Bb Cc
                    </span>
              ...
              <div className="border-t border-[#2E2542] pt-4 flex items-center justify-between">
                <div>
                  <span className="text-xs font-bold text-[#F5F2FA] block">
                    Subtle Text Shadow
                  </span>
        ...
        {activeTab === "scripture" && (
          <div className="space-y-6 max-w-4xl">
            ...
            <div
              className="w-full rounded-3xl overflow-hidden border border-[#2E2542] bg-[#0B0814] relative shadow-2xl"
            ...
            >
                ...
                <>
                  <div
                    style={{
                      ...
                      borderRadius: "50%",
                      background:
                        "radial-gradient(circle, rgba(167,136,250,0.45) 0%, rgba(167,136,250,0.1) 55%, transparent 70%)",
                      filter: "blur(4px)",
                    }}
                  />
                  <div
                    style={{
                      ...
                      borderRadius: "50%",
                      background:
                        "radial-gradient(circle, rgba(103,232,249,0.35) 0%, rgba(103,232,249,0.08) 55%, transparent 70%)",
                      filter: "blur(4px)",
                    }}
                  />
                </>
              ...
              <div
                className={`absolute p-6 inset-x-0 ${styles.bibleRefPosition?.includes("bottom") ? "bottom-0" : "top-0"} flex ${
                  styles.bibleRefPosition?.includes("left")
                    ? "justify-start"
                    : styles.bibleRefPosition?.includes("right")
                      ? "justify-end"
                      : "justify-center"
                }`}
              >
                <span className="px-4 py-1.5 rounded-full bg-[#1A1428]/80 border border-[#2E2542] backdrop-blur-md font-mono text-[11px] font-bold uppercase tracking-widest text-[#67E8F9] shadow-lg">
                  {currentVerse.book} ·{" "}
                  <span className="text-[#A788FA]">{currentVerse.ref}</span>
                </span>
              </div>
              ...
              <div
                className={`absolute inset-0 flex p-12 ${
                  styles.bibleBodyPosition === "bottom-left"
                    ...
                    : styles.bibleBodyPosition === "bottom-right"
              ...
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2">
                <span className="font-mono text-[10px] text-white/40 uppercase tracking-widest bg-black/40 px-3 py-1 rounded-full border border-white/5">
                  {styles.bibleTranslation || "KJV"}
                  {styles.bibleServiceLabel
                    ? ` · ${styles.bibleServiceLabel}`
                    : ""}
                </span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-[#1A1428] border border-[#2E2542] p-5 rounded-3xl space-y-3">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateStyle("bibleServiceLabel", e.target.value)
                  }
                ...
                <p className="text-[10px] text-[#8882A4]">
                  Appears on bottom watermark and stage reference headers.
                </p>
              </div>
            </div>
          ...
          <div className="bg-[#1A1428] border border-[#2E2542] p-6 rounded-3xl space-y-6 max-w-4xl">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[10px] text-[#8882A4] font-bold uppercase tracking-widest mt-0.5">
            ...
            <div className="border-t border-[#2E2542] pt-5">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {[
                  ...
                  {
                    title: "Sunset Glow",
                    url: "https://images.unsplash.com/photo-1472214103451-9374bd1c798e?q=80&w=500&auto=format&fit=crop",
                  },
                  {
                    title: "Deep Space",
                    url: "https://images.unsplash.com/photo-1519681393798-38e43269d496?q=80&w=500&auto=format&fit=crop",
                  },
                  {
                    title: "Holy Cross",
            ...
            <div className="max-w-4xl py-4">
              ...
              >
                <div className="p-8 text-center text-white/40">
                  Bumpers configuration locked on current plan
                </div>
              </DisabledContainer>
            </div>
          ) : (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#1A1428] border border-[#2E2542] rounded-3xl p-6 flex flex-col justify-between space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-[#8882A4] mb-4">
                      Plays before sermon or presentation recording begins.
                    </p>
                    ...
                    {bumpers.intro ? (
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between text-xs bg-[#0B0814]/70 p-3 rounded-2xl border border-[#2E2542]/60 font-mono">
                          <span className="text-[#F5F2FA] truncate max-w-[160px]">
                            {bumpers.intro.name}
                          </span>
                          <span className="text-[10px] text-[#8882A4]">
                            {formatBumperBytes(bumpers.intro.sizeBytes)} •{" "}
                            {Math.round(bumpers.intro.durationSec || 0)}s
                          </span>
                        </div>
                      </div>
                    ) : (
                      <div className="border-2 border-dashed border-[#2E2542] rounded-2xl p-8 flex flex-col items-center justify-center text-center space-y-2 bg-[#0B0814]/40">
                        ...
                        <p className="text-xs font-semibold text-[#F5F2FA]">
                          No Intro Uploaded
                        </p>
                        <p className="text-[11px] text-[#8882A4]">
                          Select MP4, MOV, WebM, or audio
                        </p>
                      </div>
                    )}
                  </div>
                ...
                <div className="bg-[#1A1428] border border-[#2E2542] rounded-3xl p-6 flex flex-col justify-between space-y-4">
                  <div>
                    ...
                    <p className="text-xs text-[#8882A4] mb-4">
                      Appended automatically when session finalize runs.
                    </p>
                    ...
                    {bumpers.outro ? (
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between text-xs bg-[#0B0814]/70 p-3 rounded-2xl border border-[#2E2542]/60 font-mono">
                          ...
                          <span className="text-[10px] text-[#8882A4]">
                            {formatBumperBytes(bumpers.outro.sizeBytes)} •{" "}
                            {Math.round(bumpers.outro.durationSec || 0)}s
                          </span>
                        </div>
                      </div>
                    ) : (
          ...
          <div className="bg-[#1A1428] border border-[#2E2542] p-6 rounded-3xl space-y-6 max-w-4xl">
            ...
            <div className="flex items-center justify-between p-4 rounded-2xl bg-[#0B0814] border border-[#2E2542]">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-[#F5F2FA]">
                    Active Speech Recognition Engine
                  </h4>
                  <p className="text-[10px] text-[#8882A4]">
                    {asrStatus?.engine
                      ? `Engine: ${asrStatus.engine}`
                      : "Native whisper.cpp with Vosk fallback"}
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-start gap-3 cursor-pointer pt-2">
                ...
                />
                <span>
                  <span className="text-sm text-[#F5F2FA] font-semibold block">
                    Filter non-target languages
                  </span>
                  <span className="text-[11px] text-[#8882A4]">
                    Skip interpreter / other-language audio segments. Applies to
                    primary mic and secondary push-to-talk.
                  </span>
                </span>
              </label>
            </div>
            ...
            <div className="border-t border-[#2E2542] pt-5 space-y-4">
              ...
              <label className="flex items-start gap-3 cursor-pointer p-4 rounded-2xl bg-[#0B0814] border border-[#2E2542] hover:border-white/20 transition-colors">
                ...
                <div className="space-y-0.5">
                  <span className="text-sm text-[#F5F2FA] font-semibold block">
                    Tier 1: Correct Live Transcript (Dictionary)
                  </span>
                  <span className="text-xs text-[#8882A4] block">
                    Fast display-only cleanup of biblical names, places, and
                    church vocabulary in real-time.
                  </span>
                </div>
              </label>
              ...
              <label className="flex items-start gap-3 cursor-pointer p-4 rounded-2xl bg-[#0B0814] border border-[#2E2542] hover:border-white/20 transition-colors">
                ...
                <div className="space-y-0.5">
                  <span className="text-sm text-[#F5F2FA] font-semibold block">
                    Tier 2: Clean Session PDF Transcript (Local Ollama AI)
                  </span>
                  <span className="text-xs text-[#8882A4] block">
                    Post-timer Ollama LLM pass before PDF compilation. The raw
            ...
            <div className="bg-[#1A1428] border border-[#2E2542] p-6 rounded-3xl space-y-4">
              ...
              {!sleepProbeOk && (
                <div className="rounded-2xl bg-amber-500/10 border border-amber-500/25 p-3 text-xs text-amber-200 flex items-center gap-2">
                  <PiWarning size={16} /> Display sleep prevention could not be
                  verified by hardware probe.
                </div>
              )}
              <div className="grid grid-cols-2 gap-3">
                {[
            ...
            {authContext &&
              (() => {
                const planInfo = formatPlanDetails(
                  authContext.auth?.subscriptionPlan ||
                    authContext.auth?.licenseTier,
                ...
                return (
                  <div className="bg-[#1A1428] border border-[#2E2542] p-6 rounded-3xl space-y-5">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-[#8882A4]">
                            Workstation entitlements and subscription status
                          </p>
                        </div>
                      </div>
                      <span
                        className={
                          ...
                          (authContext.isAuthenticated
                            ? authContext.isGracePeriod
                              ? "bg-amber-500/15 border border-amber-500/30 text-amber-300"
                              : "bg-emerald-500/15 border border-emerald-500/30 text-emerald-300"
                            : authContext.guestExpired
                    ...
                    <div className="p-4 rounded-2xl bg-gradient-to-r from-[#211838] to-[#161028] border border-[#3E3259] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                      <div>
                        <span className="text-[10px] font-black tracking-widest uppercase text-[#A788FA] block mb-1">
                      ...
                      <div className="sm:text-right">
                        <span className="text-[10px] font-black tracking-widest uppercase text-[#8882A4] block mb-1">
                          {authContext.isAuthenticated
                            ? "Days Remaining"
                            : "Guest Time Remaining"}
                        </span>
                        <div
                          className={"text-sm font-black " + planInfo.daysColor}
                        >
                          {planInfo.daysLabel}
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 p-4 rounded-2xl bg-[#0B0814] border border-[#2E2542] text-xs">
                      <div>
                        <span className="text-[#8882A4] block text-[10px] font-bold uppercase">
                          Church Organization
                        </span>
                      ...
                      <div>
                        ...
                        >
                          {authContext.isAuthenticated
                            ? authContext.auth?.hoursRemaining != null
                              ? authContext.auth.hoursRemaining + "h remaining"
                              : "72h Max Grace Period"
                            : authContext.guestExpired
                              ? "Locked (Log In Required)"
                              : `${authContext.guestRemainingMinutes}m Guest Session`}
                        </span>
                      </div>
                    </div>
                  ...
                  >
                    {updater.status === "downloaded"
                      ...
                      : updater.status === "available"
                        ...
                        : updater.status === "downloading"
                          ? `Downloading ${updater.downloadProgress?.percent || 0}%`
                          : updater.status === "checking"
                            ? "Checking..."
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="bg-[#161028] border border-[#2E2542] rounded-3xl p-6 max-w-md w-full space-y-4 shadow-2xl">
            ...
            <p className="text-xs text-[#C8C2DC] leading-relaxed">
              ...
              preferences? This will restore background colors, typography, and
