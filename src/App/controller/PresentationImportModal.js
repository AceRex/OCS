      ...
      <div className="bg-[#18181b] border border-white/10 rounded-2xl shadow-2xl p-6 max-w-lg w-full flex flex-col gap-4 text-left max-h-[85vh] overflow-hidden">
        ...
        <div className="pt-3 border-t border-white/10 flex justify-end">
          <ActionButton
            type="button"
            onClick={onClose}
            className="px-4 py-2 rounded-[12px] bg-[#00A8FF] hover:bg-[#00A8FF]/90 text-[#0B1020] text-xs font-bold uppercase tracking-wider transition-all shadow-lg shadow-[#00A8FF]/20 active:scale-95"
          >
            Got It
          </ActionButton>
        </div>
